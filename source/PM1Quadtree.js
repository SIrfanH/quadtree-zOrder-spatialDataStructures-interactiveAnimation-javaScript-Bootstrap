...
class Quadtree {
    ...
    insertLine(line) {
        ...
        // If this node does not have a vertix and qEdge
        ...
        // If this quadrant does not have a vertix but has qEdges
        } else if (this.vertex == null && this.qEdges.length != 0){

            // If this quadrant does not have any point
            if(this.points.length == 0){
                ...
                // this quadrant has points

                // If the enpoints are similar to the existing points of this quadrant then make it a vertix
                ...
                // while(i<this.points.length && !this.points[i].checkSimilarity(line.point1)
                //  && !this.points[i].checkSimilarity(line.point2)){
                //     i++;
                // }
